...
\begin{minipage}[ht]{.8\linewidth}%
   ...
   \begin{tabularx}{\linewidth}{p{1.8cm}M}% experience
      ...
      & \begin{itemize}[topsep=-12pt,parsep=0em]
          ...
          \item Oversaw the development team for DOE's COVID-19 tracking project and downstream model creation and analysis, for which I received distinguished recognition for the project %
          \item Developed containerized ETL workflows and REST APIs using Swagger for data exchange in the NAERM-RTSA project %
