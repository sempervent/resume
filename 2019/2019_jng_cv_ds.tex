...
\begin{minipage}[ht]{.8\linewidth}% 
   ...
   \begin{tabularx}{\linewidth}{p{1.8cm}M}% experience 
      ...
      \vspace{.25mm}\makecell[l]{\textbf{Data Scientist II, Subcontractor}} \\
     ...
     \begin{tabularx}{\linewidth}{p{1.8cm}M}% education 
      ...
      \vspace{.25mm}\makecell[l]{\textbf{Master of Science in Plant Sciences \textemdash Plant Molecular Genetics}} \\
