...
\sectionfont{\fontsize{10}{11}\selectfont}% 1}}}
\begin{document}% {{{1
...
\begin{minipage}[ht]{.25\linewidth}% {{{2
  ...
  \setlength{\voffset}{-0.75in}
   ...
   {\small
     ...
     \end{tabularx}}
     \flushleft% 3}}}
   \section*{\faBarChart{} Statistics}% {{{3
   \flushright
   {\small
      ...
      \flushleft% 3}}}
\end{minipage}% 2}}}
\begin{minipage}[ht]{.8\linewidth}% {{{2
   \bgroup
   \def\arraystretch{.8}
   \begin{tabularx}{\linewidth}{p{1.8cm}M}% experience {{{3
      \hline
      \textbf{Experience} & 
      ...
      & \begin{itemize}[topsep=-12pt,parsep=0em]
        ...
        \item Developed data ingestion methods using \code{cURL}, \code{PHP}, and \code{R} to scrape energy data from the web % 
        \item Streamlined training and development procedures using \code{ansible}, \code{vagrant}, \code{PHP}, and \code{BASH}
      \end{itemize} \\
      ...
      & \begin{itemize}[topsep=-12pt,parsep=0em]
       ...
       & \begin{itemize}[topsep=-12pt,parsep=0em]
         ...
         \end{itemize} \\
     \end{tabularx} % 3}}}
     \begin{tabularx}{\linewidth}{p{1.8cm}M}% education {{{3
      \hline
