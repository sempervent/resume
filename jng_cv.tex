...
\begin{minipage}[ht]{.25\linewidth}
   ...
   \begin{tikzpicture}[node distance=1cm]
      ...
      \node [pc,fill={rgb:red,2;green,2;blue,1}] at (main.north east) {Vim};
   ...
   \section*{skills}
   \flushright
   \begin{tabularx}{\linewidth}{p{.5\linewidth}X}
...
\begin{minipage}[ht]{.75\linewidth}
   ...
   \begin{tabularx}{\linewidth}{p{1.8cm}M}
      ...
      & \begin{itemize}[topsep=-12pt,parsep=0em]
        ...
        \end{itemize} \\ 
       & \makecelss[l]{\textbf{Project Manager \& Technical Sales Representative}} \\
