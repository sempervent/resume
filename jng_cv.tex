...
\begin{minipage}[ht]{.25\linewidth}
   ...
   {\large \textit{Bioinformatician}}
   \section*{contact}
   \flushright
   547 Murray Drive \\
   Knoxville, TN 37912 \\
   United States of America  \\
   \textbf{+1 (865) 803 3495}\\
   \color{headercolor}{\href{mailto:jngrant9@gmail.com}{jngrant9@gmail.com}}
   \href{http://notjustadatum.blogspot.com}{\color{headercolor}{notjustadatum.blogspot.com}}
   ...
   \begin{tabularx}{\linewidth}{p{.44\linewidth}X}
      \footnotesize Molecular Biology & \footnotesize Data Mining \\
      \footnotesize Statistics & \footnotesize Microsoft Office \\
      \footnotesize Laboratory \newline Practices & \footnotesize Tissue Culture \\
      \footnotesize Histology \& \newline Microscopy & \footnotesize Research 
   \end{tabularx}
   \flushleft
   \section*{interests}
   \flushright
   \begin{tabularx}{\linewidth}{p{.5\linewidth}p{.5\linewidth}}
      \footnotesize Data Science & \footnotesize Genetics \\
      \footnotesize Statistics & \footnotesize Microbiology \\
      \footnotesize Machine Learning & \\
      \footnotesize Automation & \\
      \footnotesize Data Visualization &
   \end{tabularx}
\end{minipage}
\begin{minipage}[ht]{.75\linewidth}
   ...
   \begin{tabularx}{\linewidth}{p{1.8cm}M}
      \hline
      \textbf{Experience} & \makecell[l]{\textbf{Bioinformatician, Project Manager, \& Technical Sales Representative}} \\
      & Microbial Insights, Knoxville, TN \textit{2016\textemdash{present}} \\
