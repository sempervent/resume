...
\newcommand{\projects}[3]{%
    ...
    \textit{#2} \\ % Summary
    \textbf{Technologies:} #3 \\ % Technologies Used
}
...
\section*{\faCogs{} Skills}
    ...
    \begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}p{0.2\linewidth}X@{}}
        \skills{\faCode}{Programming Languages}{Python, R, JavaScript, SQL, Bash, PHP, \LaTeX{}}
        \vspace{-1em}
        \skills{\faCloud}{Cloud Platforms}{AWS (S3, Lambda, EC2, RDS, Fargate), GCP, Azure}
        \vspace{-1em}
        \skills{\faDatabase}{Databases}{PostgreSQL, MongoDB, MySQL, SpatiaLite, Snowflake, SQLite, DuckDB, Redis, RabbitMQ}
        \vspace{-1em}
        \skills{\faGears}{Data Engineering}{Airflow, Prefect, Kafka, Scala, Hadoop, TimescaleDB, NiFi, ETL Pipelines}
        \vspace{-1em}
        \skills{\faObjectGroup}{Distributed Processing}{Spark, Slurm}
        \vspace{-1em}
    ...
    \projects{Cosmic Architect}{A python card game based upon populating a planet.}{Python, pygame}
    \headerline
    ...
    \begin{tabularx}{\linewidth}{M}%
        ...
        \begin{itemize}[topsep=-12pt,parsep=0em]
            ...
            \item Architecting a geospatial data pipeline, using Prefect for the ingestion, storage, and analysis of raster data in a cloud environment %
            ...
            \item Leading a team in taking legacy Python code and moedernizing  with standard libraries.
        \end{itemize} \\
    \end{tabularx}
    \begin{tabularx}{\linewidth}{M}%
